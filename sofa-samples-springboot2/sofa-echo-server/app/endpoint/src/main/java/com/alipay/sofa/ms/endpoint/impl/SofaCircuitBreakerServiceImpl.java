 ...
 * @date 2020-12-11
 */
public class SofaCircuitBreakerServiceImpl implements SofaCircuitBreakerService {
    private static final Logger logger = LoggerFactory.getLogger(SofaCircuitBreakerServiceImpl.class);
