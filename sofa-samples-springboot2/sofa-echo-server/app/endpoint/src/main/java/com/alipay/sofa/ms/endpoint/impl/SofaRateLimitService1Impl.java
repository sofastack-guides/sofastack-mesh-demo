 ...
 */
public class SofaRateLimitService1Impl implements SofaRateLimitService1 {
    private static final Logger logger = LoggerFactory.getLogger(SofaRateLimitService1Impl.class);
