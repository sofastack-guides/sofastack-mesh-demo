 ...
 */
public class SofaRouterService1Impl implements SofaRouterService1 {
    private static final Logger logger = LoggerFactory.getLogger(SofaRouterService1Impl.class);
