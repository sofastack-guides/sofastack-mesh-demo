 ...
 */
public class DubboFaultToleranceServiceImpl implements DubboFaultToleranceService {
    private static final Logger logger = LoggerFactory.getLogger(DubboFaultToleranceServiceImpl.class);
