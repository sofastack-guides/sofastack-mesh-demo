 ...
 */
public class DubboFaultInjectService1Impl implements DubboFaultInjectService1 {
    private static final Logger logger = LoggerFactory.getLogger(DubboFaultInjectService1Impl.class);
