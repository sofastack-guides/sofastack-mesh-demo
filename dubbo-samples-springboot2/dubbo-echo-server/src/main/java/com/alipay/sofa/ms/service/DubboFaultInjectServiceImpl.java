 ...
 */
public class DubboFaultInjectServiceImpl implements DubboFaultInjectService {
    private static final Logger logger = LoggerFactory.getLogger(DubboFaultInjectServiceImpl.class);
