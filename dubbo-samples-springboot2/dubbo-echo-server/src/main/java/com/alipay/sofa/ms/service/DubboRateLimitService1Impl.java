 ...
 */
public class DubboRateLimitService1Impl implements DubboRateLimitService1 {
    private static final Logger logger = LoggerFactory.getLogger(DubboRateLimitService1Impl.class);
