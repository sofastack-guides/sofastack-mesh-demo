 ...
 */
public class DubboDowngradeService1Impl implements DubboDowngradeService1 {
    private static final Logger logger = LoggerFactory.getLogger(DubboDowngradeServiceImpl.class);
