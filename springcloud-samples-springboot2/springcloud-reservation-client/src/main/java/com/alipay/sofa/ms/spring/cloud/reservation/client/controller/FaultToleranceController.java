...
import com.alipay.sofa.ms.spring.cloud.reservation.client.service.SpringCloudFaultToleranceService;
...
public class FaultToleranceController {
    ...
    @Autowired
    private SpringCloudFaultToleranceService faultToleranceService;
