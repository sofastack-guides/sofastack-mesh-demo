...
import com.alipay.sofa.ms.spring.cloud.reservation.client.service.SpringCloudCircuitBreakerService;
...
public class CircuitBreakerController {
    ...
    @Autowired
    private SpringCloudCircuitBreakerService sofaCircuitBreakerService;

    @GetMapping("/echo")
    public String echo(@RequestParam(value = "name", required = false, defaultValue = "spring cloud") String name,
