 ...
 */
@Service
public class SpringCloudCircuitBreakerServiceImpl implements SpringCloudCircuitBreakerService {
    private static final Logger logger = LoggerFactory.getLogger(SpringCloudCircuitBreakerServiceImpl.class);
