 ...
 */
@Service
public class SpringCloudDowngradeServiceImpl implements SpringCloudDowngradeService {
    private static final Logger logger = LoggerFactory.getLogger(SpringCloudDowngradeServiceImpl.class);
