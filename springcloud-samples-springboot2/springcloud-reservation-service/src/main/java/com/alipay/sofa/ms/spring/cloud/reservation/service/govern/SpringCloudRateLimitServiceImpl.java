 ...
 */
@Service
public class SpringCloudRateLimitServiceImpl implements SpringCloudRateLimitService {
    private static final Logger logger = LoggerFactory.getLogger(SpringCloudRateLimitServiceImpl.class);
