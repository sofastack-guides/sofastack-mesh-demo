 ...
 */
@Service
public class SpringCloudDowngradeService1Impl implements SpringCloudDowngradeService1 {
    private static final Logger logger = LoggerFactory.getLogger(SpringCloudDowngradeService1Impl.class);
