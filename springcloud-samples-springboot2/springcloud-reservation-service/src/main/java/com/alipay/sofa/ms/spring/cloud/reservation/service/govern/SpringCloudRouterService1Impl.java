 ...
 */
@Service
public class SpringCloudRouterService1Impl implements SpringCloudRouterService1 {
    private static final Logger logger = LoggerFactory.getLogger(SpringCloudRouterService1Impl.class);
