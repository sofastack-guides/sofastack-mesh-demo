 ...
 */
@Service
public class SpringCloudFaultToleranceServiceImpl implements SpringCloudFaultToleranceService {
    private static final Logger logger = LoggerFactory.getLogger(SpringCloudFaultToleranceServiceImpl.class);
