 ...
 */
@Service
public class SpringCloudRateLimitService1Impl implements SpringCloudRateLimitService1 {
    private static final Logger logger = LoggerFactory.getLogger(SpringCloudRateLimitService1Impl.class);
